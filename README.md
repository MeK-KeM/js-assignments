...
## Javascript Assignments  [![Build Status](https://travis-ci.org/MeK-KeM/js-assignments.svg?branch=master)](https://travis-ci.org/MeK-KeM/js-assignments)
...
```
* Open https://github.com/MeK-KeM/js-assignments and test the build icon. Now it will run all tests and update status once you push changes to github. Keep this icon green!
...
* Push your updates to github server and check if tests passed on [travis-ci](https://travis-ci.org/MeK-KeM/js-assignments/builds).
